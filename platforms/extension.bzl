...
alias( name = "host", actual = "@core-identity//platforms/linux:haswell_x86_64" )
alias( name = "host_for_crossbuild", actual = "@core-identity//platforms/linux:x86_64" )
        """)
    elif rctx.os.name.startswith("linux") and rctx.os.arch in ["aarch64", "arm64"]:
        rctx.file("BUILD.bazel", """
# DO NOT EDIT: autogenerated BUILD file
alias( name = "host", actual = "@core-identity//platforms/linux:arm64" )
alias( name = "host_for_crossbuild", actual = "@core-identity//platforms/linux:arm64" )
        """)
    elif rctx.os.name.startswith("darwin") and rctx.os.arch == "x86_64":
        rctx.file("BUILD.bazel", """
# DO NOT EDIT: autogenerated BUILD file
alias( name = "host", actual = "@core-identity//platforms/macos:x86_64" )
alias( name = "host_for_crossbuild", actual = "@core-identity//platforms/macos:x86_64" )
        """)
    elif rctx.os.name.startswith("darwin") and rctx.os.arch == "arm64":
        rctx.file("BUILD.bazel", """
# DO NOT EDIT: autogenerated BUILD file
alias( name = "host", actual = "@core-identity//platforms/macos:arm64" )
alias( name = "host_for_crossbuild", actual = "@core-identity//platforms/macos:arm64" )
        """)
    else:
